        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1><span class="glyphicon glyphicon-user"></span> Ananya Sharma</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: sharmaananya2003@gmail.com<br>
                        <span class="glyphicon glyphicon-link"></span> Facebook: www.facebook.com/sharmaananya<br>
